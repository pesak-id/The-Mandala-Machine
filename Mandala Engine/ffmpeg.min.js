  ...
  return (function (e) {
    ...
    function (e, t, r) {
      ...
      var n = r(2),
        ...
        i = n.setLogging,
        a = r(6);
      e.exports = { logging: o, setLogging: i, createWorker: a };
    },
    function (e, t, r) {
      var n = (function (e) {
        "use strict";
          ...
          (x.prototype = {
            ...
            finish: function (e) {
              for (var t = this.tryEntries.length - 1; t >= 0; --t) {
                ...
                if (r.finallyLoc === e)
                  return this.complete(r.completion, r.afterLoc), j(r), s;
              }
            },
            catch: function (e) {
              for (var t = this.tryEntries.length - 1; t >= 0; --t) {
        ...
        var O = function (e, t) {
          ...
          P = function (e) {
            ...
            return new Promise(function (e, i) {
              var a = { workerId: t, jobId: r, action: n, payload: o };
              f("[".concat(t, "]: Start ").concat(r, ", action=").concat(n)),
                O(n, e),
                k(n, i),
                x.postMessage(a, h(a));
            });
          ...
          E = function (e) {
            return P(s({ id: e, action: "load", payload: { options: c } }));
          },
          L = (function () {
            var e = o(
                    ...
                    switch ((e.prev = e.next)) {
                      ...
                      case 6:
                        return (
                          (e.t4 = e.sent),
                          (e.t5 = [e.t3, e.t4]),
                          (e.t6 = { method: "writeFile", args: e.t5 }),
                          (e.t7 = { id: e.t2, action: "FS", payload: e.t6 }),
                          (e.t8 = (0, e.t1)(e.t7)),
                          e.abrupt("return", (0, e.t0)(e.t8))
                        );
                      case 12:
                      case "end":
                        return e.stop();
          ...
          T = function (e, t) {
            return P(
              s({
                id: t,
                action: "FS",
                payload: { method: "readFile", args: [e] },
              })
            );
          },
          F = function (e, t) {
          ...
          _ = function (e, t) {
            return P(s({ id: t, action: "run", payload: { args: e } }));
          },
          A = function (e, t) {
            return P(
              s({
          ...
          R = function (e, t) {
            ...
            return _(
              "-i ".concat(e, " ").concat(r, " ").concat(t, " ").concat(n),
              o
            );
          },
          D = function (e, t, r, n) {
        ...
        return (
          m(x, function (e) {
            ...
            if ("resolve" === a) {
              var u = c.message,
                s = c.data;
              f("[".concat(t, "]: Complete ").concat(r)),
                g[o]({ workerId: t, jobId: r, message: u, data: s });
            } else {
              if ("reject" === a)
                throw (
                  (j[o](c),
    ...
    function (e, t, r) {
      ...
      e.exports = function (e) {
        ...
        return (
          ["corePath", "workerPath"].forEach(function (r) {
        ...
        var t = [],
          r = function (e) {
            e instanceof Uint8Array
              ? t.push(e.buffer)
              : e instanceof ArrayBuffer && t.push(e);
          },
          n = e.payload,
          o = n.args,
          i = n.data;
    ...
    function (e, t, r) {
      (function (t) {
        ...
        e.exports = (function (e) {
          ...
          workerPath:
            void 0 !== t && "development" === t.env.FFMPEG_ENV
              ? i(
                  "/dist/worker.dev.js?nocache=".concat(
                    Math.random().toString(36).slice(3)
                  )
                )
              : "https://unpkg.com/@ffmpeg/ffmpeg@v".concat(
                  c,
                  "/dist/worker.min.js"
                ),
          corePath: "https://unpkg.com/@ffmpeg/core@v".concat(
            u["@ffmpeg/core"].substring(1),
            "/ffmpeg-core.js"
          ),
          workerBlobURL: !0,
        });
    ...
    function (e, t) {
      e.exports = { logger: function () {}, progress: function () {} };
    },
    function (e, t) {
      e.exports = function (e) {
        var t,
